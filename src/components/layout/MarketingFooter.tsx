      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 text-sm sm:px-6 md:grid-cols-[1.3fr_0.8fr_1fr] lg:px-8">
        <div>
          ...
          <p className="mt-5 max-w-md leading-7 text-[#425B76]">
            ...
            businesses run CoachFort-hosted branded program pages, enrollment
            requests, live classes, materials, community, invoices, manual
            payments, and receipts from one clean platform.
          </p>
